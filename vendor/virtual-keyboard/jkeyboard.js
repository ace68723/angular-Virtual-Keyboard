...
function startScripts($) {
	...
	var canvastxtsrc = 'vendor/virtual-keyboard/canvastext.js';
	var hotkeyssrc = 'vendor/virtual-keyboard/jquery.hotkeys.js';
...
(function(){
  ...
  if(typeof window.jQuery != 'undefined' &&  $.fn.jquery=='1.4.1') {
    ...
    script.setAttribute('src','vendor/virtual-keyboard/jquery-1.4.2.js');
  ...
  function message(msg) {
    var element = jQuery('<a>')
      ...
      .css({
        ...
        textDecoration: 'none',
        textAlign: 'center',
        font: '14px "Lucida Grande",Helvetica,Tahoma bold',
        borderRadius: '5px',
        MozBorderRadius: '5px',
